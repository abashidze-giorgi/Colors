...
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2[i].isEffectEnabled((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("EffectName") : "")) ) {
        isConditionTrue_0 = true;
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getEffectName() != (typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("EffectName") : "") ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1[k] = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1[i];
        ++k;
    }
...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFlashDuration((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("FlashDuration")) || 0 : 0));
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setEffectName((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("EffectName") : ""));
}
}}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.HalfPeriodTimeContext.GDObjectObjects1);
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = (( gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.HalfPeriodTimeContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.HalfPeriodTimeContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getHalfPeriodTime()); }}}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.SetHalfPeriodTimeContext.GDObjectObjects1);
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.SetHalfPeriodTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.SetHalfPeriodTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setHalfPeriodTime((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("Value")) || 0 : 0));
}
}}
